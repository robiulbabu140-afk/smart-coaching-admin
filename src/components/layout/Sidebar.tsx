...
import {
  ...
  CreditCard, Bell, BarChart3, LogOut, School,
} from 'lucide-react';
import { useAuthStore } from '../../store/authStore';

const links = [
  { to: '/', icon: LayoutDashboard, label: 'ড্যাশবোর্ড' },
  { to: '/students', icon: Users, label: 'স্টুডেন্ট' },
  { to: '/teachers', icon: GraduationCap, label: 'টিচার' },
  { to: '/batches', icon: BookOpen, label: 'ব্যাচ' },
